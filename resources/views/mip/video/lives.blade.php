...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{env('CDN_URL')}}/mip/css/videoList.css?rd=201804">
@endsection
@section('js')
...
@section('banner')
    <div id="Navigation">
        <h1>JRS低调看爱看球直播</h1>
        <div class="banner">
            <mip-img height="26" width="75" src="{{env('CDN_URL')}}/mip/img/image_slogan_nav.png"></mip-img>
            <button on="tap:my-lightbox.toggle" id="btn-open" role="button" tabindex="0" class="league"></button>
        </div>
    </div>
@endsection
@section('content')
    <div class="publicAd"><a href={{\App\Http\Controllers\Mip\UrlCommonTool::downloadUrl()}}><mip-img src="{{env('CDN_URL')}}/mip/img/image_ad_wap.jpg"></mip-img></a></div>
