...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{\App\Http\Controllers\Mip\UrlCommonTool::MIP_PREFIX}}/css/anchorPhone.css?rd=201808141800">
@endsection
@section('banner')
    <div id="Navigation">
        @if(isset($h1))
    ...
    <div class="default" id="Anchor">
        ...
        <ul>
            @foreach($hotAnchors as $hotAnchor)
                <li><a href="{{\App\Http\Controllers\Mip\UrlCommonTool::anchorRoomUrl($hotAnchor->room->id)}}"><mip-img width="40" height="40" src="{{isset($hotAnchor['icon']) ? $hotAnchor['icon'] : '/mip/img/image_player_n.jpg'}}"></mip-img><p>{{$hotAnchor['name']}}</p></a></li>
            @endforeach
        </ul>
    </div>
    <div class="default" id="Live">
        ...
        <ul>
            ...
            <div class="nolist separated">
                <mip-img height="110" width="110" src="{{\App\Http\Controllers\Mip\UrlCommonTool::MIP_PREFIX}}/img/image_blank_noneanchor_n.png"></mip-img>
                <p>还没有主播在直播喔~</p>
            </div>
        </ul>
    </div>
