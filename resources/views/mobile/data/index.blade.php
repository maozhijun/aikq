                    ...
                    <div class="table_con rank" style="display: ;">
                        <table>
                            ...
                            @for($i = 0 ; $i < count($league['score']); $i++)
                                ...
                                <tr>
                                    <td>{{$item['rank']}}</td>
                                    <td><a href="{{\App\Http\Controllers\PC\CommonTool::getTeamDetailUrl(2,$league['league']['id'],$item['tid'])}}"><img src="{{\App\Models\Match\BasketTeam::getIcon($item['ticon'])}}">{{$item['tname']}}</a></td>
                                    <td>{{$item['win']}}</td>
                                    <td>{{$item['lose']}}</td>
                                    <td>{{$item['win_diff']}}</td>
                                </tr>
