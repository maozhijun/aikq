...
@section('content')
    ...
    <p id="PC"><a href="http://m.aikanqiu.com/download.html">下载爱看球APP，流畅度快3倍<br/>www.aikanqiu.com</a><button class="close" onclick="this.parentNode.style.display='none'"></button></p>
@endsection
@section('bottom')
