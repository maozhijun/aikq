...
@section('css')
    ...
    <link rel="stylesheet" type="text/css" href="{{env('CDN_URL')}}/css/mobile/v2/record_list_wap_2.css?t=201903250913">
@endsection
@section('banner')
    <div id="Navigation">
        <h1>爱看球</h1>
...
@endsection
@section('js')
    <script type="text/javascript" src="{{env('CDN_URL')}}/js/mobile/v2/record_list_wap_2.js?201903250913"></script>
