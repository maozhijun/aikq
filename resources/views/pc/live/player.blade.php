...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{env('CND_URL')}}/css/pc/player.css?rd=201808201154">
...
{{--<script type="text/javascript" src="{{env('CND_URL')}}/js/testSocket3.js?timd={{date('YmdHi')}}"></script>--}}
</html>