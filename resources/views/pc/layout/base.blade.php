...
<head>
    ...
    <?php
        $title = isset($title) ? $title : '爱看球-爱看球直播|爱看球JRS|JRS直播|NBA直播|NBA录像|CBA直播|英超直播|西甲直播|低调看|直播吧|CCTV5在线';
...
<div id="Bottom">
    ...
    <p class="business"><a target="_blank" href="/live/business.html">站长合作</a></p>
