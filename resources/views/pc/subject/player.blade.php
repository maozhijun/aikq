...
{{--<head>--}}
    ...
    {{--<link rel="stylesheet" type="text/css" href="{{env('CND_URL')}}/css/pc/style.css?rd=2018">--}}
    {{--<link rel="stylesheet" type="text/css" href="{{env('CND_URL')}}/css/pc/player.css?rd=201901181541">--}}
    {{--<meta http-equiv="X-UA-Compatible" content="edge" />--}}
    {{--<meta name="renderer" content="webkit|ie-stand|ie-comp">--}}
    {{--<meta name="baidu-site-verification" content="nEdUlBWvbw">--}}
    {{--<link rel="Shortcut Icon" data-ng-href="{{env('CND_URL')}}/img/pc/ico.ico" href="{{env('CND_URL')}}/img/pc/ico.ico">--}}
{{--</head>--}}
{{--<body scroll="no">--}}
{{--<div class="player_content" id="MyFrame">--}}
    {{--<p class="noframe" style="display: none;">距离比赛还有 <b>08:23</b><img class="code" src="{{env('CND_URL')}}/img/pc/image_qr_868.jpg">加微信 <b>fs188fs</b><br/>与球迷赛事交流，乐享高清精彩赛事！</p>--}}
{{--</div>--}}
{{--</body>--}}
...
{{--</script>--}}
{{--<script type="text/javascript" src="{{env('CND_URL')}}/js/public/pc/player3.js?rd=201808281556"></script>--}}
{{--<script>--}}
    {{--$.ajaxSetup({--}}
