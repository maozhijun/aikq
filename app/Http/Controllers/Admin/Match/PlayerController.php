...
class PlayerController extends Controller
{
    ...
    public static function saveImagesJson(array $newImages) {
        ...
        Storage::disk('public')->put('static/json/pc/dd_image/images.json', json_encode($images));
        Storage::disk('public')->put('static/json/m/dd_image/images.json', json_encode($images));
//        Storage::disk('public')->put('m/dd_image/images.json', json_encode($images));
    }

    public static function getAdImages() {
        try {
            $string = Storage::get("public/static/json/pc/json/dd_image/images.json");
