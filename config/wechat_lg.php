...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID_LG', 'your-app-id'),         // AppID
    'secret'  => env('WECHAT_SECRET_LG', 'your-app-secret'),     // AppSecret
    'token'   => env('WECHAT_TOKEN_LG', 'your-token'),          // Token
    'aes_key' => env('WECHAT_AES_KEY_LG', ''),                    // EncodingAESKey
